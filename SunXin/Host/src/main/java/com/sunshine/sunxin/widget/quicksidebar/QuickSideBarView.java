package com.sunshine.sunxin.widget.quicksidebar;
...
public class QuickSideBarView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLetters.size(); i++) {
            ...
            float yPos = mItemHeight * i  + rect.height() + (mItemHeight - rect.height())/2.0f + getPaddingTop();
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        final int newChoose = (int) ((y - mItemStartY- getPaddingTop()) / mItemHeight);
        switch (action) {
                ...
                if (oldChoose != newChoose) {
                    if (newChoose >= 0 && newChoose < mLetters.size()) {
                        ...
                        if (listener != null) {
                            ...
                            float yPos = mItemHeight * mChoose + (mItemHeight)/2.0f + getPaddingTop();
